...
![virtual box version](https://i.imgur.com/mVcZKAP.png)

- [Vagrant](https://github.com/netology-code/devops-materials), рекомендуем версию 2.3.4

![vagrant version](https://i.imgur.com/yYoxJ0K.png)

- [Packer](https://github.com/netology-code/devops-materials/blob/master/README.md) версии 1.9.х + плагин от Яндекс Облако по [инструкции](https://cloud.yandex.ru/docs/tutorials/infrastructure-management/packer-quickstart)

![packer version](https://i.imgur.com/Mdn2Exe.png)
![packer version](https://i.imgur.com/yKzzc7N.png)

- [уandex cloud cli](https://cloud.yandex.com/ru/docs/cli/quickstart) Так же инициализируйте профиль с помощью ```yc init``` .
  
![yc version](https://i.imgur.com/sY9TAHy.png)
...
Зашел в ВМ, docker установлен

![](https://i.imgur.com/5bqTULo.png)
![](https://i.imgur.com/9RvEmVs.png)
